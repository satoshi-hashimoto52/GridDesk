...
contextBridge.exposeInMainWorld("gridDesk", {
  ...
  setWindowBounds: (boundsPatch) => ipcRenderer.invoke("window:setBounds", boundsPatch),
  ...
  readPdfPreview: (targetPath) => ipcRenderer.invoke("file:readPdfPreview", targetPath),
